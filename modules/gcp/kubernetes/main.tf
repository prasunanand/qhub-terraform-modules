...
locals {
  ...
  cluster_output_http_load_balancing_enabled        = google_container_cluster.main.addons_config[0].http_load_balancing.disabled
  cluster_output_horizontal_pod_autoscaling_enabled = google_container_cluster.main.addons_config[0].horizontal_pod_autoscaling.disabled
